...
def baja_proveedor():
    ...
    posant=0 #pos puntero al inicio
    linea=archivo.readline()
    encontrado=False   
...
def modificar_proveedor():
    ...
    CUIT, nombre, apellido = ingresodatos()
    posant=0 # puntero al inicio
    linea=archivo.readline()
    encontrado=False   
    while linea and not encontrado: # leo todo el archivo o hasta que encontrado = True
        v_CUIT, v_nombre,v_apellido, v_activo=linea.split(";")   #guardo los datos de la linea en 5 variables que van a ser los que estan en el txt, no los que escribi por input
